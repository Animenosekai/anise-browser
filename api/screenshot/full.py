...
def hello(path):
    try:
        ...
        result = CHROME.fullpage_screenshot(request.values.get("url", None), width=request.values.get("width", None, int), base64=base64) # the result should in this variable
